class MainPageLocators():
    ...
    INPUT_NAME = "/html/body/div[5]/div/div[2]/form/div[1]/label[1]/div[2]/input"
    INPUT_PHONE = "/html/body/div[5]/div/div[2]/form/div[1]/label[2]/div[2]/input"
    INPUT_EMAIL = "/html/body/div[5]/div/div[2]/form/div[1]/label[3]/div[2]/input"
    INPUT_NAME_COMPANY = "/html/body/div[5]/div/div[2]/form/div[1]/label[4]/div[2]/input"
    ...
    ASK_QUESTION = '//*[@id="advantagesSection"]/section/div/div[2]/div/div[2]/div/button'

    COMPANY = "//div[@class='advantages-select-tab']//li[@id='companies']"
    BUTTON_GET_OFFER_COMPANY = '//*[@id="advantagesSection"]/section/div/div[3]/div/div[2]/div/button'

    PARTNERS = "//div[@class='advantages-select-tab']//li[@id='partners']"
    BUTTON_GET_OFFER_PARTNERS = '//*[@id="advantagesSection"]/section/div/div[4]/div/div[2]/div/button'

    #########################################################################################################################################################################################
    ASK_QUESTION_USER = '//*[@id="faqSection"]/section/div/div[2]/div[2]/button'


    ASK_QUESTION_COMPANY = "//ul[@class='select-tab faq__select-tab']//li[@id='companies']"
    ASK_QUESTION_GET_OFFER_COMPANY = '//*[@id="faqSection"]/section/div/div[2]/div[2]/button'

    ASK_QUESTION_PARTNERS = "//ul[@class='select-tab faq__select-tab']//li[@id='partners']"
    ASK_QUESTION_GET_OFFER_PARTNERS = '//*[@id="faqSection"]/section/div/div[2]/div[2]/button/div'
