...
- [Запуск и просмотр allure отчетов по тестам](#Запуск и просмотр allure отчетов по тестам)
- [Лицензия](#лицензия)
- [Авторы](#авторы)
...
## Запуск и просмотр allure отчетов по тестам
Шаг 1: Установите необходимые библиотеки

Откройте терминал в PyCharm и выполните следующие команды для установки pytest и allure-pytest:
  ```sh
     pip install pytest allure-pytest
   ```
Шаг 2: Запустите тесты с параметром --alluredir

В терминале PyCharm выполните команду, чтобы запустить тесты из определенной папки и файла с сохранением результатов для Allure:
  ```sh
     pytest tests_journal/test_with_company.py --alluredir=allure-results
   ```
Шаг 3: Сгенерируйте и откройте Allure отчет

После завершения тестов выполните команды для генерации и открытия Allure отчета:
